...
export function normalizeCompanionConnection(
  ...
  return {
    ...
    userNameOverride: connection?.userNameOverride?.trim() || '',
    purposeOverride: connection?.purposeOverride?.trim() || '',
    descriptionOverride: connection?.descriptionOverride?.trim() || '',
